"""
Basic Message Server - Simple server without clustering
Uses Time Sync and Message Storage components.

Note: For full distributed system with consensus and failover,
use server_cluster.py instead.
"""
